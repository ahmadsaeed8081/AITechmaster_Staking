...
const waitForTransaction2 = useWaitForTransaction({
  ...
  async function mount() {
    ...
    try {
      ...
      let balance = await contract1.methods.balanceOf(address.toString()).call();

      // balance = web3.utils.fromWei(balance, "ether");
      console.log("my balanace "+balance);
  ...
  function find_Exp_earn(amount) {
    ...
    if (Number(amount) >= Number(minimum_investment) && amount < 100) {
      return (amount / 100) * 1 * 400;
    } else if (amount >= 100 && amount < 1000) {
      return (amount / 100) * 1.2 * 400;
    } else if (amount >= 1000 && amount < 10000) {
      return (amount / 100) * 1.3 * 400;
    } else if (amount >= 10000) {
      return (amount / 100) * 1.5 * 400;
    }
    return 0;
                ...
                <div className="box flex items-center">
                  <div className="box-item flex flex-col justify-center">
                    <div className="flex items-center">
                      ...
                      <CopyToClipboard
                        text={`https://staking.aitechmasters.com?ref=${address}`}
                      >
                    ...
                    <div className="link">
                    https://staking.aitechmasters.com?ref=
                      {address == null
                        ? "..."
